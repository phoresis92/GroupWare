...
public class Email {
	...
	public Email(int email_id, String email_title, String email_content, String email_file, String email_path) {
	...
	public Email(int email_id, int receive_member_id, int send_member_id, Date send_time, int email_status) {
		this.email_id = email_id;
