...
public class Email {
	...
	public Email(String member_id, String email_account, String email_pw, int email_id, int external_email_id,
			String sender_id, String sender, String receiver_id, String receiver, String title, String content,
			String content_html, String content_plain, Date send_date, String file, String email_path,
			byte email_status, byte type, MultipartFile report) {
		this.member_id = member_id;
		this.email_account = email_account;
		this.email_pw = email_pw;
	...
	public String toString() {
		return "Email [member_id=" + member_id + ", email_account=" + email_account + ", email_pw=" + email_pw
				...
				+ ", file=" + file + ", email_path=" + email_path + ", email_status=" + email_status + ", type=" + type
				+ ", report=" + report + "]";
	}
