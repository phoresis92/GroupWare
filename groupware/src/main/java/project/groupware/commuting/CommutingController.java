...
public class CommutingController {
	...
	@RequestMapping("/commuting/statistics")
	public ModelAndView aaaa (@RequestParam(value="year", required=false) String yearS,
			@RequestParam(value="month", required=false) String monthS,
			@RequestParam(value="day", required=false) String dayS,
			@RequestParam(value="dPick", required=false) String dPick) {
		
		ModelAndView mav = new ModelAndView("/commuting/statistics");
