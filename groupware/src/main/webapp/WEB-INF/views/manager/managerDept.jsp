    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
      		<button id="modal_btn_add_dept" type="button" class="btn btn-outline-primary" data-dismiss="modal">추가</button>
        	<button id="modal_btn_edit_dept" type="button" class="btn btn-outline-primary" data-dismiss="modal">수정</button>
