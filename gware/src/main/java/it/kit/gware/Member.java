...
public class Member {
	...
	public Member(int member_id, String member_pw, String member_name, String member_birth, String member_email,
			String member_address1, String member_address2, String member_address3, int member_phone,
			int member_department, int member_rank, Date member_indate, Date member_modidate) {		
	...
	public String toString() {
		return "Member [member_id=" + member_id + ", member_pw=" + member_pw + ", member_name=" + member_name
				+ ", member_birth=" + member_birth + ", member_mail=" + member_email + ", member_address1="
