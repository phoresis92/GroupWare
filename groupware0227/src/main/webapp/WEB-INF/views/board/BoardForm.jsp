			...
			<div class="col-sm text-left">
				...
				action="${pageContext.request.contextPath}/email/write"	method="post">
					<div class="form-group">
						<label for="title">작성자:</label> <input type="text" class="form-control" id="brdwriter" name="brdwriter"
							value="<c:out value="${sessionScope.member.member_name}"/>" readonly />
					...
					<div align="center">
						...
						<input type="hidden" name="brdno"
							value="<c:out value="${boardInfo.brdno}"/>"> <a
							href="${pageContext.request.contextPath}/boardList"
							class="btn btn-primary">돌아가기</a> <a href="#"
							class="btn btn-primary" onclick="fn_formSubmit()">저장</a>
					</div>
