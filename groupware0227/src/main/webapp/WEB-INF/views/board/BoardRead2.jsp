	...
	<div class="row content">
			...
			<div class="col-sm text-left" style="border: 1px solid lightgray; margin: 20px;">
				<form action="${pageContext.request.contextPath}/board"	method="post" name="board">
					...
					<br>
						...
						<div class="row">
						<div class="col-sm-4"><h4><strong>${boardInfo.brdtitle}</strong></h4></div>
		...
		<div style="border: 1px solid; width: 600px; padding: 5px">
			<form id="form1" name="form1">
				...
				작성자: <input type="text" id="rewriter1" name="rewriter" size="20" maxlength="20" value="<c:out value="${sessionScope.member.member_name}"/>"> <br/>
