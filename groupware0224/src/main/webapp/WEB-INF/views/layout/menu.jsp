...
$(function(){
	...
	$('.collapse .w3-border').addClass('show'); // 나중에 삭제
});
...
<div id="collapse_approval" class="collapse w3-border show">
    ...
    <div id="collapse_approval1" class="collapse w3-border show">
		...
		<div><a class="card-link" href="${pageContext.request.contextPath}/apv_Vacat">근태/휴가결재</a></div>
		<div><a class="card-link" href="${pageContext.request.contextPath}/apv_payment">지출결재</a></div>
...
<a class="card-link w3-button w3-block w3-left-align w3-border-bottom" data-toggle="collapse" href="#collapse_calendar"><i class="fas fa-calendar-alt"></i> 일정관리</a>
<div id="collapse_calendar" class="collapse w3-border show">
...
<div id="collapse2" class="collapse w3-border show">
     ...
     <div><a class="card-link" href="${pageContext.request.contextPath}/boardList">게시판</a></div>
...
<div id="collapse_manager" class="collapse w3-border show">	 
     <div><a class="card-link" data-toggle="collapse" href="#collapse_manager_member">회원 관리</a></div>
    	 <div id="collapse_manager_member" class="collapse w3-border show">
    	 	<div><a class="card-link" href="${pageContext.request.contextPath}/manager/unauthorized?page=1">가입 승인</a></div>
    	 	<div><a class="card-link" href="${pageContext.request.contextPath}/manager/member?page=1">회원 관리</a></div>
    	 </div>	 
     <div><a class="card-link" href="${pageContext.request.contextPath}/manager/department?page=1">부서 관리</a></div>
     <div><a class="card-link" href="${pageContext.request.contextPath}/manager/rank?page=1">직급 관리</a></div>
     <div><a class="card-link" data-toggle="collapse" href="#collapse_manager_approval1">결재 관리</a>
     ...
     <div><a class="card-link" data-toggle="collapse" href="#collapse_manager_approval2">일정 관리</a>
