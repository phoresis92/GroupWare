...
public class Approval_Dto implements Comparable<Approval_Dto> {
	...
	private Date approval_startdate;	
	...
	public String toString() {
		return "Approval_Dto [approval_id=" + approval_id + ", approval_cate=" + approval_cate + ", approval_member_id="
				...
				+ ", approval_indate=" + approval_indate + ", approval_cc=" + approval_cc + ", file=" + file
				+ ", approval_startdate=" + approval_startdate + ", approval_enddate=" + approval_enddate
				+ ", member_name1=" + member_name1 + ", member_name2=" + member_name2 + ", member_name3=" + member_name3
				+ ", department_name1=" + department_name1 + ", department_name2=" + department_name2
				+ ", department_name3=" + department_name3 + ", apv_auth_name1=" + apv_auth_name1 + ", apv_auth_name2="
				+ apv_auth_name2 + ", apv_auth_name3=" + apv_auth_name3 + ", apv_cate_name=" + apv_cate_name
				+ ", member_name=" + member_name + ", department_name=" + department_name + ", rank_name=" + rank_name
				+ ", rank_name1=" + rank_name1 + ", rank_name2=" + rank_name2 + ", rank_name3=" + rank_name3
				+ ", approval_auth_date1=" + approval_auth_date1 + ", approval_auth_date2=" + approval_auth_date2
				+ ", approval_auth_date3=" + approval_auth_date3 + "]";
	}
	public Approval_Dto() {
		super();
	}
	public Approval_Dto(int approval_id, int approval_cate, int approval_member_id, String approval_mem1,
			...
			String approval_return, Date approval_indate, String approval_cc, MultipartFile file,
			Date approval_startdate, Date approval_enddate, String member_name1, String member_name2,
			String member_name3, String department_name1, String department_name2, String department_name3,
			String apv_auth_name1, String apv_auth_name2, String apv_auth_name3, String apv_cate_name,
			String member_name, String department_name, String rank_name, String rank_name1, String rank_name2,
			String rank_name3, Date approval_auth_date1, Date approval_auth_date2, Date approval_auth_date3) {
		super();
		...
		this.file = file;
		this.approval_startdate = approval_startdate;
	...
	public Date getApproval_startdate() {
		return approval_startdate;
	}
	public void setApproval_startdate(Date approval_startdate) {
		this.approval_startdate = approval_startdate;
	}
