...
$.getList = function(p){	
	...
	$.ajax({
		...
		success:function(data){
			...
			var str = '';
			if (type == 0){
				str += '<button type="button" id="btn_delete" class="btn btn-primary btn-sm" disabled>삭제</button>&nbsp;';
				str += '<button type="button" class="btn btn-primary btn-sm" disabled>읽음</button>&nbsp;';
			} else if (type == 1){
				str += '<button type="button" id="btn_delete" class="btn btn-primary btn-sm" disabled>삭제</button>&nbsp;';
				str += '<button type="button" id="btn_read" class="btn btn-primary btn-sm" disabled>읽음</button>&nbsp;';				
			} else if (type == 3){
				str += '<button type="button" id="btn_delete" class="btn btn-primary btn-sm" disabled>삭제</button>&nbsp;';
				str += '<button type="button" id="btn_restore" class="btn btn-primary btn-sm" disabled>복구</button>&nbsp;';				
			}
	...
	<div class="row content">			
		...
		<c:choose>
				...
				<c:otherwise>					
					...
					<div>
						<select name="option" class="btn btn-primary dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						...
						<div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        	<div class="input-group">
                       			<input type="text" class="form-control bg-light border-0 small" name="condition" placeholder="검색어 입력" aria-label="Search" aria-describedby="basic-addon2">
	                        	<div class="input-group-append">
	                        		<button class="btn btn-primary" id="btn_email_opt" type="button"><i class="fas fa-search fa-sm"></i></button>
	                        	</div>
					        </div>
				        </div>				        
				    </div>
