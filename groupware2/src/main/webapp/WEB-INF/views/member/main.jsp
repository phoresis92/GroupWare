...
<head>
  ...
  <link href="${pageContext.request.contextPath}/resources/css/digitalclock.css" rel="stylesheet" />
        ...
        <div class="container-fluid">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">(<span id="calCount3"></span>)</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">(<span id="apvCount4"></span>)</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">당월 출석현황</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
         ...
         <div class="card-body">
                 ...
                 <input type="hidden" id="commuting_member_id" value="${sessionScope.member.member_id}"/>
                   ...
                   <div id="arrive" class="card bg-info text-white shadow">
                    <div class="card-body">
                     출근체크
                      <div class="text-white-50 small">9시 이전에 체크해주세요!</div>
                         ...
                         <div id="leave" class="card bg-warning text-white shadow">
                   <div class="card-body">
                      퇴근체크
                  ...
                  <div class="card bg-secondary text-white shadow float-left" style="width:50%;">
                  	<div class="card-body">
                  aef;lahsefl;aisefl;iashef;lhias;elfih
                  	</div>
                  </div>
                  </div>
