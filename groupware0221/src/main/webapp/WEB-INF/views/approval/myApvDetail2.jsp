...
<div class="container">
	...
	<td colspan="3">(연차)&nbsp;<fmt:formatDate value="${ apvDto.approval_startdate }"  pattern="yyyy-MM-dd"/>&nbsp;~&nbsp;<fmt:formatDate value="${ apvDto.approval_enddate }"  pattern="yyyy-MM-dd"/></td>
	</c:when>
	<c:when test="${ fn:contains(apvDto.approval_cc, '2_halfVacat') }">
	<td colspan="3">(반차)&nbsp;<fmt:formatDate value="${ apvDto.approval_startdate }"  pattern="yyyy-MM-dd HH:mm:ss"/>&nbsp;~&nbsp;<fmt:formatDate value="${ apvDto.approval_enddate }"  pattern="yyyy-MM-dd HH:mm:ss"/></td>
	</c:when>
